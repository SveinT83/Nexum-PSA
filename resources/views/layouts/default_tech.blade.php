    ...
    <body class="d-flex flex-column min-vh-100">
        ...
        <footer class="mt-auto py-3">
            <div class="container-fluid text-center">
                <div class="row gy-2">
                    <p class="mb-0">&copy; {{ date('Y') }} {{ $companyProfile['company_name'] ?? config('app.name', 'Nexum PSA') }}. All rights reserved. <span class="opacity-75">v{{ config('app.version', '0.2.0') }}</span></p>
