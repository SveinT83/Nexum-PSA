...
/**
 * Publishes Notification domain documentation into the Knowledge module.
 */
class NotificationKnowledgeDocumentationSeeder extends Seeder
{
    public function run(RenderArticleBody $renderer): void
    {
        ...
        $chapter = Chapter::query()->updateOrCreate(
            ...
            [
                'name' => 'Notifications',
                'description' => 'Notification channels, in-app delivery, personal preferences, and external Talk delivery.',
                'priority' => 520,
                'source_system' => 'nexum',
                'source_type' => 'notification-docs',
                'sync_status' => 'pending',
            ],
        );
    ...
    {
        $basePath = app_path('Modules/Notification/Docs/knowledge');

        return [
            [
                'title' => 'Notification Channels',
                'slug' => Str::slug('Notification Channels'),
                'path' => $basePath . '/notification-channels.md',
            ],
        ];
    }
}
