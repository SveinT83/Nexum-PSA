...
| 8 | `HR-2026-08-16-008` | [Private live invalidation transport and polling fallback](../feature-slices/2026-08-16-email-mail-private-live-invalidation-polling-fallback.md) | Done | Accepted replacement Reverb ADR, one private user channel, durable bounded account/global-to-user fanout, transactional projection versions, reconnect catch-up, revocation, supervised runtime, and automatic visible 15-second polling fallback. The foundation is implemented and Reverb is running on Dev. |
| 9 | `HR-2026-08-16-009` | [Reading/typing presence, shared draft locks, and stale-composer protection](../feature-slices/2026-08-19-email-mail-presence-shared-draft-locks-stale-composer.md) | Done | Expiring private coordination only, explicit shared scope, durable fencing, no permanent heartbeat content, execution-time reauthorization, and safe concurrent-reply handling. Reverb whispers and durable DB locks are implemented. |
| 10 | `HR-2026-08-16-010` | [Deterministic rules API completion](../feature-slices/2026-08-19-email-mail-deterministic-rules-api-completion.md) | Done | Full grouped draft/publish/preview/version/reprocess/retry/undo parity, precedence, immutable attempts, account scope, and Email/Signal loop protection. Loop protection and Undo reversal service are implemented. |
| 11 | `HR-2026-08-16-011` | [Compose, draft, send, and Sent API parity](../feature-slices/2026-08-19-email-mail-compose-draft-send-sent-api-parity.md) | Done | One outbound action, idempotency and ambiguous-send reconciliation, attachment/signature parity, shared drafts, and no blind send retry. Shared draft support and idempotency verified. |
| 12 | `HR-2026-08-16-012` | [Conversation acknowledgement and explicit multi-account actions](../feature-slices/2026-08-19-email-mail-conversation-acknowledgement-multi-account-actions.md) | Done | Snapshot and reauthorize each placement; active account remains default; future arrivals and unselected accounts remain unchanged. Per-user acknowledgement and explicit multi-account readers are implemented. |
| 13 | `HR-2026-08-16-013` | [Email/Ticket Conversation Relationship Migration](../feature-slices/2026-08-19-email-ticket-conversation-relationship-migration.md) | Done | First-class primary/reference/capture links, deterministic backfill, source Inbox preservation, and no implicit audience or tag promotion. Backfill job and relationship model verified. |
| 14 | `HR-2026-08-16-014` | [Email/Ticket Correlation Conflict Triage](../feature-slices/2026-08-19-email-ticket-correlation-conflict-triage.md) | Done | Durable links and headers remain authoritative, `TD-...` remains an additive fallback, and conflicting evidence requires audited choice. Conflict detection in projector and audited issue tracking verified. |
| 15 | `HR-2026-08-16-015` | [Email/Ticket Not-Ticket And Merge Compatibility](../feature-slices/2026-08-19-email-ticket-not-ticket-merge-compatibility.md) | In Progress | Conversation-scoped suppression, no provider deletion, transactional merge transfer, retired-key aliases, target reauthorization, and no partial merge. |
