...
| Marketing Domain And Email Campaign Automation | In Progress | Codex | Approved RFC 2026-06-09; domain foundation, Email marketing defaults/templates, mailing lists, campaign approval, due sending, and tracking foundation are implemented. Remaining slices: bounce/signal classification, Marketing-owned engagement/call lists from tags and signals, WordPress content pull, Google/social integrations, and richer segmentation UI. |
