...
| Domain API Foundation | In Progress | Codex | Scoped Sanctum API keys now enforce Client/Site, Asset, Contact, Ticket, Task, Knowledge, Storage, Calendar, Risk, Email Inbox, Notification, and Sales API scopes. |
