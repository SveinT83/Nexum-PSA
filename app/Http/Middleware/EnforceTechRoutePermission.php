...
class EnforceTechRoutePermission
{
    ...
    private const ROUTE_PERMISSION_PATTERNS = [
        ...
        'tech.my-day.*' => 'warroom.view',
        'tech.reports.*' => 'report.view',
        'tech.admin.system.signals.settings.*' => 'signal.rule.manage',
        ...
        'tech.admin.system.signals.executions.retry' => 'signal.action.execute',
        ...
        'tech.signals.executions.retry' => 'signal.action.execute',
        ...
        'tech.marketing.lists.update' => 'marketing.list.manage',
        'tech.marketing.lists.destroy' => 'marketing.list.manage',
        'tech.marketing.lists.refresh' => 'marketing.list.manage',
        'tech.marketing.lists.contacts.*' => 'marketing.list.manage',
        ...
        'tech.marketing.campaigns.content-sources.*' => 'marketing.campaign.edit',
        'tech.marketing.campaigns.schedule.*' => 'marketing.campaign.edit',
        ...
        'tech.admin.settings.tickets.rules.store' => 'ticket.rule_publish',
        'tech.admin.settings.tickets.rules.update' => 'ticket.rule_publish',
        'tech.admin.settings.tickets.rules.toggle' => 'ticket.rule_publish',
        'tech.admin.settings.tickets.rules.destroy' => 'ticket.rule_publish',
        'tech.admin.settings.tickets.rules' => 'ticket.manage_rules',
        'tech.admin.settings.tickets.rules.executions.actions.retry' => 'ticket.rule_retry',
        'tech.admin.settings.tickets.rules.executions.rerun.preview' => 'ticket.rule_full_rerun',
        'tech.admin.settings.tickets.rules.executions.rerun.store' => 'ticket.rule_full_rerun',
        'tech.admin.settings.tickets.rules.executions.index' => 'ticket.rule_execution_view',
        'tech.admin.settings.tickets.rules.executions.show' => 'ticket.rule_execution_view',
        'tech.admin.settings.tickets.rules.show' => 'ticket.manage_rules',
        'tech.admin.settings.tickets.rules.*' => 'ticket.manage_rules',
        ...
        'tech.admin.system.integrations.rmm-alert-rules.*' => 'integration.rmm_manage',
        'tech.admin.system.integrations.nable_rmm.*' => 'integration.rmm_manage',
        'tech.admin.system.integrations.tactical_rmm.*' => 'integration.rmm_manage',
        'tech.admin.system.integrations.*' => 'integration.view',
        'tech.admin.system.customer-portal.invitations.store' => 'customer_portal.invite',
        'tech.admin.system.customer-portal.invitations.revoke' => 'customer_portal.manage',
        'tech.admin.system.customer-portal.memberships.disable' => 'customer_portal.manage',
        'tech.admin.system.customer-portal.*' => 'customer_portal.view',
        'tech.admin.system.intake.forms.create' => 'intake.manage',
        'tech.admin.system.intake.forms.store' => 'intake.manage',
        'tech.admin.system.intake.forms.edit' => 'intake.manage',
        'tech.admin.system.intake.forms.update' => 'intake.manage',
        'tech.admin.system.intake.forms.toggle' => 'intake.manage',
        'tech.admin.system.intake.submissions.reviewed' => 'intake.submission_review',
        'tech.admin.system.intake.submissions.route-sales' => 'intake.submission_review',
        'tech.admin.system.intake.attachments.download' => 'intake.view',
        'tech.admin.system.intake.*' => 'intake.view',
        'tech.admin.system.booking.settings.create' => 'booking.manage',
        'tech.admin.system.booking.settings.store' => 'booking.manage',
        'tech.admin.system.booking.settings.edit' => 'booking.manage',
        'tech.admin.system.booking.settings.update' => 'booking.manage',
        'tech.admin.system.booking.settings.toggle' => 'booking.manage',
        'tech.admin.system.booking.requests.confirm' => 'booking.request_review',
        'tech.admin.system.booking.requests.decline' => 'booking.request_review',
        'tech.admin.system.booking.*' => 'booking.view',
        'tech.admin.system.data-exchange.profiles.create' => 'data_exchange.manage',
        'tech.admin.system.data-exchange.profiles.edit' => 'data_exchange.manage',
        'tech.admin.system.data-exchange.runs.store' => 'data_exchange.run',
        'tech.admin.system.data-exchange.files.download' => 'data_exchange.download',
        'tech.admin.system.data-exchange.imports.dry-run' => 'data_exchange.import',
        'tech.admin.system.data-exchange.imports.commit' => 'data_exchange.approve_import',
        'tech.admin.system.data-exchange.schedules.*' => 'data_exchange.schedule',
        'tech.admin.system.data-exchange.delivery-targets.*' => 'data_exchange.delivery',
        'tech.admin.system.data-exchange.*' => 'data_exchange.view',
        'tech.admin.system.relationships.create' => 'relationships.manage',
        'tech.admin.system.relationships.store' => 'relationships.manage',
        'tech.admin.system.relationships.edit' => 'relationships.manage',
        'tech.admin.system.relationships.update' => 'relationships.manage',
        'tech.admin.system.relationships.rotate-secrets' => 'relationships.manage',
        'tech.admin.system.relationships.documentations.push' => 'relationships.sync',
        'tech.admin.system.relationships.knowledge.push' => 'relationships.sync',
        'tech.admin.system.relationships.*' => 'relationships.view',
        ...
        'tech.tickets.relationships.escalate' => 'relationships.escalate',
        ...
        'tech.tasks.time-entries.*' => 'task.update',
        ...
        'tech.economy.orders.export' => 'data_exchange.run',
        'tech.economy.orders.portal-visibility.update' => 'economy.order_manage',
