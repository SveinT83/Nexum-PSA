    ...
    */
    ...
    public function sampleVariables(EmailTemplate $template): array
    {
        ...
        $samples = [
            ...
            'campaign_body' => 'We can help your organization improve operations with practical services from our team.',
            'campaign_heading' => 'New services from our team',
            'campaign_intro' => 'Here is a short update we think may be useful for your business.',
            'campaign_subject' => 'Useful business news',
