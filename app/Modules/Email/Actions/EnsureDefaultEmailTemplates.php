    ...
    public function templates(): array
    {
        return [
            ...
            [
                ...
                'body_html' => '<p>Hello {{ contact_name }},</p><p>Your quote is ready:</p>{{ quote_customer_copy_html }}<p><strong>Price summary</strong><br>{{ quote_summary_html }}</p><p><a href="{{ quote_url }}">View quote</a></p><p>Expires: {{ expires_at }}</p><p>Regards,<br>{{ seller_name }}</p>',
                'body_text' => "Hello {{ contact_name }},\n\nYour quote is ready:\n\n{{ quote_customer_copy_text }}\n\nPrice summary\n{{ quote_summary_text }}\n\n{{ quote_url }}\n\nExpires: {{ expires_at }}\n\nRegards,\n{{ seller_name }}",
                'variables' => ['opportunity_key', 'opportunity_title', 'client_name', 'contact_name', 'quote_key', 'quote_url', 'quote_summary_html', 'quote_summary_text', 'quote_customer_copy_html', 'quote_customer_copy_text', 'expires_at', 'seller_name'],
                'is_default' => true,
                'is_active' => true,
            ],
            [
