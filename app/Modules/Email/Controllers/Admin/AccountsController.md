...
Controller file: `app/Modules/Email/Controllers/Admin/AccountsController.php`
...
- Is reachable through routes defined in `app/Modules/Email/routes.php`, `routes/techAdmin.php`, `routes/api.php`, or `routes/web.php` depending on endpoint type.
