# Tech Services – Functional Specification
...
- tech.services.index → /tech/services
- tech.services.create → /tech/services/create
- tech.services.edit → /tech/services/{service}/edit
- tech.admin.settings.services → /tech/admin/settings/services
...
- App\\Http\\Controllers\\Tech\\Services\\ServiceIndexController
- App\\Http\\Controllers\\Tech\\Services\\ServiceCreateController
- App\\Http\\Controllers\\Tech\\Services\\ServiceEditController
- App\\Http\\Controllers\\Tech\\Admin\\Settings\\ServiceSettingsController
...
## 2) tech.services.index

**URL:** `tech.services.index` → `tech.services.index.view` → `/tech/services`  
 **Access:** `service.view`  
 **Status:** Not completed  
 **Difficulty:** Medium  
...
## 3) tech.services.create

**URL:** `tech.services.create` → `/tech/services/create`  
...
## 4) tech.services.edit

**URL:** `tech.services.edit` → `/tech/services/{service}/edit`  
...
## 5) tech.admin.settings.services

**URL:** `tech.admin.settings.services` → `/tech/admin/settings/services`  
...
- `GET /tech/services` → index (permission: `service.view`)
- `GET /tech/services/create` → create form (permission: `service.create`)
- `POST /tech/services` → store (permission: `service.create`)
- `GET /tech/services/{service}/edit` → edit form (permission: `service.create` owner OR `service.admin`)
- `PUT/PATCH /tech/services/{service}` → update (same as edit)
- `POST /tech/services/{service}/archive` → archive (permission: as edit)
- `DELETE /tech/services/{service}` → delete (only if no active references)
- `GET/POST /tech/admin/settings/services` → settings (permission: `service.admin` or `tech.admin`)
