...
namespace App\Modules\Documentation\Livewire\Admin;
...
class TemplateForm extends Component
{
    ...
    public function save()
    {
        ...
        if ($this->templateId) {
            ...
            return redirect()->route('tech.admin.system.templatesManagement.doc.index');
        }
    }

    public function render()
    {
        return view('documentation::Livewire.Admin.TemplateManagement.Doc.template-form', [
