...
Controller file: `app/Modules/Documentation/Controllers/Tech/DocumentationController.php`

## Purpose

`DocumentationController` handles the technician-facing Documentation area.
...
- `app/Modules/Documentation/Views/Tech/index.blade.php`
...
### `App\Modules\Taxonomy\Models\Category`
...
- File naming follows the module move: `README-controller.md`.
