...
Controller file: `app/Modules/Documentation/Controllers/Admin/TemplateManagementController.php`

## Purpose (current state)
This document describes how `TemplateManagementController` works today, based on the current implementation and its active routes.
...
- File naming follows controller naming: `TemplateManagementController.md`.
